...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/gunhan/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/gunhan/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'gunhan.c1ckai62k0pf.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'gunhan-capstone-django' # please enter your s3 bucket name
